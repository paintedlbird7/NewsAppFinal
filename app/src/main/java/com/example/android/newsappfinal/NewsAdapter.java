...
public class NewsAdapter extends ArrayAdapter<News> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        String formattedMagnitude = formatMagnitude(currentNews.getmMagnitude());
        ...
        // Get the appropriate background color based on the current news magnitude
        int magnitudeColor = getMagnitudeColor(currentNews.getmMagnitude());
        // Set the color on the magnitude circle
        magnitudeCircle.setColor(magnitudeColor);

        // Get the original location string from the News object,
        // which can be in the format of "5km N of Cairo, Egypt" or "Pacific-Antarctic Ridge".
        String originalLocation = currentNews.getmLocation();
    ...
    /**
     * Return the color for the magnitude circle based on the intensity of the news.
     *
     * @param magnitude of the news
     */
